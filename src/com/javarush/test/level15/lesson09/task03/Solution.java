...
public class Solution
{
    ...
    /*обявляем как статики без инициализации*/
...
/*Если хотим проинициализировать заносим этиже переменные в блок statc который пишем ниже
* это будет своего рода конструктор нашего класса
* static
* {
*      intVar = 5;
       doubleVar = 5.0;
       ...
       ExceptionVar = ;
       StringVar = "Abracadabra";*
* }
* так или другим сложным кодом
* */
