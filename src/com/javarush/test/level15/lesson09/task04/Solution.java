...
public class Solution
{
    ...
    static
    {
        if (A == 0) // обманываем компилятор т.е. заставляем его зайти в этот блок
        {
            A = 5 / 0;// а тут его ожидает засада деление на ноль т.е. инициализируем А операцией деления на 0
