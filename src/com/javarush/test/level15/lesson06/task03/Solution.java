...
public class Solution {
    ...
    public class Machine  implements Runnable {//убираем extends Object  и  убираем конструктор

    }

    public class Car extends Machine  {////убираем extends Object  и  убираем конструктор
