...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        int nYear = Integer.parseInt(n);//преобразовываем строку в число.
        int x = 365;
        if (nYear%4 == 0 && nYear%100 != 0 || nYear%400 == 0)//год является високосным в двух случаях: (либо он кратен 4, но при этом не кратен 100), либо кратен 400.
        {
            x += 1;
