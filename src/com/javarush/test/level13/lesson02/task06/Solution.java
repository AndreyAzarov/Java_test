...
public class Solution
{
    ...
    interface DBObject
    {
        User initializeIdAndName(long id, String name);//объявляем метод который должен вернуть данные типа
        // User
    }
    ...
    static class User implements DBObject
    {
        ...
        public User initializeIdAndName(long id, String name) {//вынесли реализацию метода сюда в класс
            this.id = id;
            this.name = name;
            return this;
        }
