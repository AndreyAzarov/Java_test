...
3. Метод printListValues должен принимать параметр list и вывести в консоль
все элементы из списка list:
- метод ничего не возвращает
- найди нужный блок кода в конструкторе, в котором в цикле из списка list
 выводятся в консоль все значения
...
//list.add(new Float(-90 / -0/0)); - Если поделим на дробный ноль то получим бесконечность
...
//Метод возвращает истину, если это значение Float является Not-A-Number (NaN), иначе ложь.
                } else if (object instanceof Double) {
                    Double a = (Double) object;
                    System.out.println("Is double value infinite? " + a.isInfinite());

//Метод возвращает истину, если Double значение бесконечно велико по величине, иначе ложь.
                }
            }
        }
    }
